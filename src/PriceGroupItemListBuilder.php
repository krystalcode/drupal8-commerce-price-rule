 ...
 */
class PriceGroupItemListBuilder extends EntityListBuilder implements FormInterface {
  ...
  public function getFormId() {
    return 'commerce_price_group_items';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($this->entities as $entity) {
      ...
      $form['price_group_items'][$entity->id()] = $row;
    }

    if ($this->hasTableDrag) {
      $form['price_group_items']['#tabledrag'][] = [
        'action' => 'order',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    foreach ($form_state->getValue('price_group_items') as $id => $value) {
