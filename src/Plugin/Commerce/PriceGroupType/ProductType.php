...
/**
 * Price group type that creates a group of different priduct types.
 *
 * Provides a config form for selecting the desired product types for the group.
 *
 ...
 * )
 */
class ProductType extends PriceGroupCalculationBase {
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->configuration['product_types'] = $values;
  }
